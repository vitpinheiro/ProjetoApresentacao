...
class VisualizarApresentacoesUI:
    ...
    def main():
        ...
        VisualizarApresentacoesUI.visualizar()
    def visualizar():
        ...
        for x in View.apresentacao_listar():
            if usuario.get_id()==x.get_id_banda():
                cidade = View.cidade_listar_id(x.get_id_cidade())
                data = x.get_data()
                apresentacoes_usuario.append({"cidade":cidade.get_nome() if cidade!=None else 0,"data":data})
